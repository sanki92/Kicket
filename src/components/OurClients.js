...
const OurClients = ({isPhone, clients}) => {
  ...
  return (
    <div className="w-[85%] relative mx-auto mt-[5rem] my-10 smM:mb-2">
      <h2 className="text-white text-[45px] text-center font-[750] mb-12  smM:text-[7vw] smM:whitespace-nowrap">
        Our Clients
      </h2>
      ...
      <div className="relative flex flex-col justify-center">
        ...
        >
          ...
          <div className="bg-[#73717138] grid place-content-center max-w-[10rem] h-[10rem] smM:max-w-[5rem] smM:h-[5rem] rounded-full">
            <img className="mx-auto smM:w-10" src={`https://kicketapi.webprismits.us/assets/clients/${e.logo}`} />
          </div>
