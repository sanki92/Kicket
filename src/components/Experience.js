    ...
    <div className="my-[5rem] smM:mt-[2rem] flex justify-center items-center h-[30rem] smM:h-[15rem]">
      ...
      >
        ...
        <div className="flex smM:items-end items-center justify-center flex-col w-[24rem] text-center smM:p-4">
          <h1 className="text-[#EBEBEB] text-[30px] leading-[36px] mb-4 smM:text-[4.3vw] smM:text-right smM:leading-[23px] smM:whitespace-nowrap">
            Experience It Live: <br className="hidden smM:block"/> Request Your Demo Today
          </h1>
