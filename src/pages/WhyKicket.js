      ...
      <div className="">
        ...
        >
          <h1 className="text-[#FFC019] font-[750] text-[45px]">
            {language === "ar" ? "لماذا كيكت" : "Why Kicket"}
          </h1>
        ...
        <div className=" flex lgM:flex-col lgM:items-center text-white  text-[20px] w-[85%] smM:w-[90%] mx-auto gap-x-14 mt-14">
          <img
            src={`https://kicketapi.webprismits.us/assets/about/${about.image}`}
          ...
          <div className="flex flex-col justify-center gap-y-5 lgM:items-center">
            <h1
              ...
              className="text-white font-[750] text-[45px] smM:text-[7vw] smM:whitespace-nowrap smM:text-center smM:mt-3"
            >
              {language === "ar" ? "عن كيكت" : "About Kicket"}
            </h1>
        ...
        <div className=" flex lgM:flex-col lgM:items-center text-white text-[20px] w-[85%] smM:w-[90%] mx-auto gap-x-14 mt-14">
          ...
          <div className="flex flex-col justify-center gap-y-10">
            ...
            className="text-white font-[750] lgM:text-center text-[45px] smM:text-[7vw] smM:whitespace-nowrap smM:text-center smM:mt-5">
